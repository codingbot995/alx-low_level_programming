...
* @ht: hash table you want to add or update the key/value to them
* @key: is the key
* @value: value associated with the key (value key)
...
/**
* createNode - creates a new node to added to hash_table
* @key:  the key
