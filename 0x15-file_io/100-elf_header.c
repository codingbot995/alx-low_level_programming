 ...
 *
 * Return: 0 if the first n bytes of s1 and s2 are equal, else  non-zero
 */
...
/**
 * _close - close a file descriptor and print an error message if  failure
...
/**
 * _read - read from a file and print an error message if  failure
